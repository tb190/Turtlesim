...
########## FILL HERE ##########
# NAME & SURNAME: TANAY BENSU YURTTÜRK
...
class TurtleCleaner(Node):
    ...
    def clear_area(self,points):
        ...
        enlarge = 0.1 # the amount that will enlarge in at each iteration
        ...
        while True:
            ...
            self.secondLoop(points,enlarge,point_x_max,point_x_min,point_y_max,point_y_min,linear_speed,angular_speed)
